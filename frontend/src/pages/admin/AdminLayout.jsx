    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-56 bg-gray-900 flex flex-col shrink-0">
        <div className="px-6 py-5 border-b border-gray-800">
          <span className="text-white font-bold text-lg tracking-tight">ReportGen</span>
          <span className="ml-2 text-xs bg-teal-600 text-white px-1.5 py-0.5 rounded font-medium">Admin</span>
        </div>
        ...
        <div className="px-6 py-4 border-t border-gray-800">
          <NavLink to="/" className="text-xs text-gray-500 hover:text-gray-300 transition-colors">
            ← Volver a la app
          </NavLink>
        </div>
      </aside>
